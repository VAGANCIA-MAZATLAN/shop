document.addEventListener("DOMContentLoaded", () => {
    // Buscamos el menú del carrito y el overlay (la capa oscura)
    const cartMenu = document.getElementById('cart-menu') || document.querySelector('.cart-sidebar');
    const cartOverlay = document.querySelector('.cart-overlay') || document.querySelector('.overlay');

    // Los desactivamos por completo en esta página
    if (cartMenu) {
    ...
    // El resto de tu lógica (renderCheckoutCart, etc.)
    renderCheckoutCart();
});
...
if (payBtn) {
  payBtn.addEventListener("click", () => {
    ...
    // Abrir WhatsApp
        ...
        // 🔥 CAMBIO AQUÍ: 
        // Si NO hay un checkoutCart en el session, significa que compró el carrito normal.
        // Solo en ese caso limpiamos el localStorage.
