...
function ajustarImagenHero() {
  const heroImg = document.getElementById('hero-img');
  
  if (window.innerWidth <= 768) {
    heroImg.src = "images/The Mas Mobile.jpg";
  } else {
    heroImg.src = "images/The Mask.jpg";
  }
}

// Ejecutar al cargar la página
window.addEventListener('load', ajustarImagenHero);
// Ejecutar si el usuario cambia el tamaño de la ventana (opcional)
window.addEventListener('resize', ajustarImagenHero);
...
function ajustarImagenHero() {
  ...
  // Solo ejecutamos el cambio si es móvil
  if (window.innerWidth <= 768) {
    heroImg.src = "images/The Mask Mobile.jpg";
  } else {
    // En PC se queda la original del HTML
    heroImg.src = "images/The Mask.jpg";
  }
}

// Escuchadores de eventos para que se active al cargar o rotar el cel
window.addEventListener('load', ajustarImagenHero);
window.addEventListener('resize', ajustarImagenHero);